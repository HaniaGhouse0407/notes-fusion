...
ga_tracking_id = 'G-F4BQ714WJE'  # Replace with your actual tracking ID
ga_track_page(ga_tracking_id, 'Home')
st.set_page_config(page_title="NoteFusion", page_icon="📝", layout="wide",initial_sidebar_state="collapsed")
...
headers = {
    'Authorization': 'Bearer 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'
}
